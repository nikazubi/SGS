...
import TrimesterDashBoard from "../main/pages/trimester/TrimesterDashBoard";
...
const useNavigationData = () => {
    ...
    const pages = useMemo(() => ({
        TRIMESTER: {
            id: 'TRIMESTER',
            name: 'ტრიმესტრის ნიშნები',
            component: <TrimesterDashBoard/>,
            icon: <Grading/>,
            show: false,
        ...
        MONTHLY_GRADE: {
            id: 'MONTHLY_GRADE',
            name: 'ტრიმესტრის შემაჯამებელი ნიშნები',
