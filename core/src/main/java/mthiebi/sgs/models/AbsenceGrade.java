...
@Table(name = "ABSENCE_GRADES", indexes = {
        @Index(name = "idx_absence_grades_student_class", columnList = "student_id, class_id"),
        @Index(name = "idx_absence_grades_exact_month", columnList = "exact_month")
})
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
